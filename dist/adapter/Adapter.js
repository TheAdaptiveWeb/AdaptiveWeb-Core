 ...
 */
class Adapter {
    constructor(id, name, description, version, script = '', tags = [], preferenceSchema = {}, about) {
        this.id = id;
        this.name = name;
    ...
    static fromObject(obj) {
        if (typeof obj === 'string')
            obj = JSON.parse(obj);
        return new Adapter(obj.id, obj.name, obj.description, obj.version, obj.script, obj.tags, obj.preferenceSchema, obj.about);
    }
}
